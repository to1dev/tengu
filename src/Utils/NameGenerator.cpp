        ...
        { { "s",
            ...
            { "X",
                { "Big head monster", "Tiny foot beast", "Giant claw fiend",
                    ...
                    "Silent screaming horror", "Warped skeletal juggernaut",
                    "Void Maw Titan", "Shattered Bone Golem", "Abyssal Crawler",
                    "Cyber-Lich Revenant", "Plasma Spine Fiend",
                    "Whispering Horror", "Neon Wraith Stalker",
                    "Nightmare Husk", "Doom-Eyed Phantom", "Shadow Drifter",
                    "Ooze-Fused Juggernaut", "Warpstorm Leviathan",
                    "Molten Claw Beast", "Fleshless Serpent",
                    "Cobalt-Plated Warfiend", "Hyper-Evolved Abomination",
                    "Glass-Fanged Gargoyle", "Quantum Parasite",
                    "Eldritch Vine Horror", "Lightning-Spined Abomination",
                    "Lurking Iron Revenant", "Soul-Cracked Golem",
                    "Blood-Tide Titan", "Infinite Howl Specter",
                    "Warped Flesh Reaper", "Sentient Viral Horror",
                    "Petrified Fang Colossus", "Cybernetic Doom Herald",
                    "Toxic Pulse Abomination", "Silent Veil Specter",
                    "Time-Torn Phantom", "Void-Spliced Monstrosity",
                    "Neural-Warp Hydra", "Gilded Bone Horror",
                    "Radiant Abyss Stalker", "Cataclysmic Iron Warden",
                    "Twisted Rift Tyrant", "Mind-Warp Leviathan",
                    "Astral Bound Terror", "Storm-Eyed Sentinel",
                    "Chimeric Horror Golem", "Thousand-Limbed Devourer",
                    "Dagger-Mouthed Specter", "Shapeless Nightmare Fiend",
                    "Lich-Lord of the Wastes", "Deep Space Aberration",
                    "Warp-Flux Mutant", "Crimson Storm Automaton",
                    "Spectral Virus Host", "Clawed Hunger Spawn",
                    "Frozen Core Behemoth", "Ever-Watching Horror",
                    "Blacklight Phantom", "Dripping Maw Parasite",
                    "Galactic Husk Abomination", "Omen-Eyed Wraith",
                    "Cobalt-Skinned Horror", "Nightshade Bone Fiend",
                    "Riftborn Terror", "Scorched Iron Juggernaut",
                    "Death Spore Revenant", "Bladed Rift Horror",
                    "Aether-Drinker Phantom", "Static-Limbed Horror",
                    "Molten Soul Warfiend", "Runebound Flesh Colossus",
                    "Blood-Soaked Plagueborn", "Unchained Abyss Fiend",
                    "Celestial Maw Horror", "Hell-Sworn Automaton",
                    "Eclipse-Eyed Sentinel", "Warp-Core Abomination",
                    "Sunken Depth Horror", "Neural-Storm Juggernaut",
                    "Fractured Time Entity", "Spiral-Eyed Ghoul",
                    "Twilight Wraith Revenant", "Ever-Consuming Maw",
                    "Neon-Spined Warfiend", "Gravity-Bent Leviathan",
                    "Corroded Steel Titan", "Cyclone-Eyed Phantom",
                    "Voidroot Terror", "Circuit-Bound Revenant",
                    "Petrified Eclipse Horror", "Glass-Skin Parasite",
                    "Silence-Wrapped Horror", "Time-Drowned Lich",
                    "Storm-Weaver Colossus", "Chain-Dripped Warbeast",
                    "Mirror-Clawed Revenant", "Plague-Born Flesh Titan",
                    "Celestial Rust Golem", "Necrotic Frost Colossus",
                    "Warp-Infested Fleshfiend", "Neural Coil Terror",
                    "Star-Touched Plagueborn", "Echo-Scarred Wraith",
                    "Moonlit Husk Revenant", "Gore-Clad Doomwalker",
                    "Blood-Veined Horror", "Plasma Rift Abomination",
                    "Thunder-Split Monstrosity", "Voidborn Husk Fiend",
                    "Cyber-Shriek Lich", "Dagger-Winged Wraith",
                    "Soul-Devouring Shadow", "Hyper-Evolved Bioweapon",
                    "Circuit-Warped Terror", "Aether-Spliced Horror",
                    "Dread-Spiral Specter", "Whisper of the Deep One",
                    "Tentacled Starspawn", "Shrine Maw of Azal'Yog",
                    "Dream-Eater from Leng", "Gibbering Sleeper",
                    "Elder Slime of Y'ha-nthlei", "Madness-Wrapped Behemoth",
                    "Eyes Beneath the Waves", "Harbinger of the Black Void",
                    "Crawling Chaos Spawn", "Thousand-Toothed Oracle",
                    "Flesh-Scroll Reader", "Watcher Beyond the Nebula",
                    "Tongue of the Tides", "Ritual Husk of N'kai",
                    "Abyssal Chanting Horror", "Star-Crowned Abomination",
                    "The Thing That Waits", "Hollow-Faced Prophet",
                    "Blood-Tide Priest of Dagon", "Inverted Spire Walker",
                    "Screaming Idol of Ubbo-Sathla",
                    "Shambler of Infinite Echoes",
                    "Covenant of the Crawling Maw",
                    "Eye-Tyrant of the Outer Dark", "Ancient Dream Parasite",
                    "The Grinning Moonspawn", "Zealot of the Nameless Depths",
                    "Tentacle-Clad Heretic", "He Who Slithers Through Thought",
                    "Vessel of the Sleepless God", "Spawn of the Black Reef",
                    "The Whispering Glyph", "Yog-Touched Leviathan",
                    "Tide-Born Apostle", "Worm of the Endless Chant",
                    "Cyclopean Ruin Crawler", "The Pale Tongue",
                    "Astral Bile Thing", "Eater of Forbidden Texts",
                    "Shadow Beyond Reason", "Seraph of Rot and Madness",
                    "The Inkwell Drowned", "Void-Marked Pilgrim",
                    "Seeker of the Sealed Gate", "The Crawling Parchment",
                    "Silent Choir of the Deep", "Heir of Black R'lyeh",
                    "Mist-Wrapped Eater",
                    "Terror from the Howling Tesseract" } } });
    return *symbols;
}
