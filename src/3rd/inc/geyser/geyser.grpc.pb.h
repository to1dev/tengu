...
class Geyser final {
 public:
  ...
  typedef WithAsyncMethod_Subscribe<WithAsyncMethod_Ping<WithAsyncMethod_GetLatestBlockhash<WithAsyncMethod_GetBlockHeight<WithAsyncMethod_GetSlot<WithAsyncMethod_IsBlockhashValid<WithAsyncMethod_GetVersion<Service > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Subscribe<WithCallbackMethod_Ping<WithCallbackMethod_GetLatestBlockhash<WithCallbackMethod_GetBlockHeight<WithCallbackMethod_GetSlot<WithCallbackMethod_IsBlockhashValid<WithCallbackMethod_GetVersion<Service > > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_Ping<WithStreamedUnaryMethod_GetLatestBlockhash<WithStreamedUnaryMethod_GetBlockHeight<WithStreamedUnaryMethod_GetSlot<WithStreamedUnaryMethod_IsBlockhashValid<WithStreamedUnaryMethod_GetVersion<Service > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_Ping<WithStreamedUnaryMethod_GetLatestBlockhash<WithStreamedUnaryMethod_GetBlockHeight<WithStreamedUnaryMethod_GetSlot<WithStreamedUnaryMethod_IsBlockhashValid<WithStreamedUnaryMethod_GetVersion<Service > > > > > > StreamedService;
};
